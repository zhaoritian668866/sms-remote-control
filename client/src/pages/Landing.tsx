...
const APK_DOWNLOAD_URL = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663393087442/EbOXiCBuhnqwgQRR.apk";
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 animate-[ink-fade_1s_ease-out_1.4s_both]">
            ...
            >
              ...
              <div className="text-left">
                ...
                <span className="block text-xs font-body text-muted-foreground">v2.0.0 · 26.5 MB</span>
              </div>
            </a>
            <button
              onClick={() => setLocation("/login")}
